...
**Go** is one of the most complex board game in existence. This game was invented in china more than 2500 years ago and continuously played by us to the present day.
...
It is a two player game and they can use either white or black stone(*pieces*). The goal is to capture more territory. It looks simple but it is one of the most complex games in existence.
...
We still have AI that can perform only specific task which is described as the Artificial Narrow Intelligence(ANI). Researchers are working to create **Artificial General Intelligence(AGI)** and is believed to be achieved before 2050. AGI can perform any task that humans can.
...
Today the data generated by us is huge and becomes hard to absorb, interpret and make complex decisions based on that data. So AI can be used find complex patterns in data that we will struggle to discover.
...
- *Chatbots* use AI to understand the meaning of the sentence and be more human like.
...
- Social media platforms use AI to give users a *personalized newsfeed* and they also use it to show the relevant ads according to your interest.
...
- *Google search engine* uses AI to find the relevant search results to your queries.
